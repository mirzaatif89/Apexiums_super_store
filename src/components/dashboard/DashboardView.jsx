...
export const DashboardView = () => {
  ...
  // Key KPI Numbers
  const totalRevenue = Math.round(finance.summary.totalRevenue * multiplier);
  const totalExpenses = Math.round(78500 * multiplier);
  const netProfit = totalRevenue - totalExpenses;
  const totalOrders = Math.round(1840 * multiplier);
  ...
  const chartData = [
    { month: 'Jan', revenue: Math.round(32000 * multiplier), expenses: Math.round(14000 * multiplier) },
    { month: 'Feb', revenue: Math.round(41000 * multiplier), expenses: Math.round(18000 * multiplier) },
    { month: 'Mar', revenue: Math.round(38000 * multiplier), expenses: Math.round(16000 * multiplier) },
    { month: 'Apr', revenue: Math.round(52000 * multiplier), expenses: Math.round(21000 * multiplier) },
    { month: 'May', revenue: Math.round(61000 * multiplier), expenses: Math.round(25000 * multiplier) },
    { month: 'Jun', revenue: Math.round(58000 * multiplier), expenses: Math.round(23000 * multiplier) },
    { month: 'Jul', revenue: Math.round(74000 * multiplier), expenses: Math.round(28000 * multiplier) },
    { month: 'Aug', revenue: Math.round(89000 * multiplier), expenses: Math.round(31000 * multiplier) }
  ];

  // Category sales pie data
  const categoryPieData = [
    { name: 'Electronics', value: 45, color: '#2563EB' },
    { name: 'Fashion', value: 25, color: '#E11D48' },
    { name: 'Home & Kitchen', value: 18, color: '#059669' },
    { name: 'Beauty & Health', value: 12, color: '#9333EA' }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          trend="up"
          trendValue="+12.1%"
          description="Fulfillment rate 98.4%"
          icon={ShoppingCart}
          accentColor="blue"
        ...
        <StatCard
          ...
          trend="up"
          trendValue="+14 new"
          description="5 categories active"
          icon={Package}
          accentColor="indigo"
          onClick={() => setActiveTab('products')}
        />
        ...
        <StatCard
          ...
          description="Multi-vendor network"
          icon={Store}
          accentColor="amber"
        ...
        <StatCard
          ...
          trend="up"
          trendValue="$1.9M total equity"
          description="Active funding"
          icon={TrendingUp}
          accentColor="purple"
