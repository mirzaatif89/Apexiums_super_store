...
export default function StorefrontHome({ onLogin, session, onLogout }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F62C40] text-slate-900 font-sans">
      <Header
        storeName={storeName}
      ...
      <main className="relative z-10 flex-1 overflow-hidden rounded-t-[28px] bg-[#F8F9FA] pt-3 pb-24 shadow-xl sm:rounded-t-[36px] sm:pb-28 space-y-0">
        {categoryPage ? (
