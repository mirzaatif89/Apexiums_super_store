...
export default function Footer({ storeName = "Apexiums", logoSrc, categories = [], onCategoryClick, onAdminClick }) {
  ...
  const manualPaymentUrl = getWhatsAppUrl(`Hello ${storeName}, I want to make a manual payment for my order.`);
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-600 leading-relaxed max-w-md font-medium">
                Pakistan's leading online store for  fashion, home essentials & lifestyle products with fast delivery and authentic items.
              </p>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex flex-wrap gap-2.5 items-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex h-8 items-center rounded-lg bg-white px-2.5 py-1 shadow-xs border border-slate-200/90 hover:scale-105 transition gap-1.5"
                >
                  <CreditCard size={15} className="text-[#E8262A]" />
                  <span className="text-[10px] font-bold text-slate-700 leading-tight">Manual Payment</span>
                </a>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <a href="https://www.facebook.com/share/1DobGSAJjE/" className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1877F2] text-white hover:opacity-90 transition shadow-xs" title="Facebook">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.instagram.com/elistin_com?stkn=M2I0cDFrOXdjZGM3" className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 text-white hover:opacity-90 transition shadow-xs" title="Instagram">
                ...
                <a href="https://www.tiktok.com/@elistin.com" className="flex h-8 w-8 items-center justify-center rounded-full bg-black hover:opacity-90 transition shadow-xs" title="TikTok" aria-label="TikTok">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-6 sm:gap-8 xl:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs text-slate-600 font-medium">
                ...
                <li><a href={manualPaymentUrl} target="_blank" rel="noreferrer" className="hover:text-[#E8262A] transition">Manual Payment via WhatsApp</a></li>
              </ul>
            </div>
        ...
        <div className="order-first grid grid-cols-2 gap-x-3 gap-y-4 rounded-2xl border border-slate-200/90 bg-slate-50 p-3 sm:gap-6 sm:p-6 lg:grid-cols-4">
          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-600 font-medium">Hassle-free returns within 2 days</p>
            </div>
          </div>
